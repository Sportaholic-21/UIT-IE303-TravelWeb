	...
	<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
		<div class="sb-sidenav-menu">
			<div class="nav">
				...
				<div class="collapse" id="collapsePages"
					...
					<nav class="sb-sidenav-menu-nested nav accordion"
						...
						<a class="nav-link"
							...
							href="${pageContext.request.contextPath}/admin/tour/add">
							Add Tour
				...
				<a class="nav-link collapsed" href="#" data-toggle="collapse"
					data-target="#collapseBookedTour" aria-expanded="false"
				...
				<div class="collapse" id="collapseBookedTour"
					aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
					<nav class="sb-sidenav-menu-nested nav accordion"
						id="sidenavAccordionPages">
						<a class="nav-link"
				...
				<a class="nav-link collapsed" href="#" data-toggle="collapse"
					data-target="#collapseFeedback" aria-expanded="false"
				...
				<div class="collapse" id="collapseFeedback"
					...
					<nav class="sb-sidenav-menu-nested nav accordion"
						...
						<a class="nav-link collapsed"
							href="${pageContext.request.contextPath}/admin/feedbacks">Feedback
							List
