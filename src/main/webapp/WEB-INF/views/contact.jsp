...
#map {
	...
	<jsp:body>
  		<div class="contact pb-0"
			style="background: linear-gradient( rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.3)), url('${pageContext.request.contextPath}/resources/images/contact-background.jpg');">
	  			...
	  			<div class="contact__content ms-auto me-auto text-dark">
	  				<div class="row align-items-start justify-content-between">
						<div class="col-5">
							...
							<input type="submit"
										class="btn btn-info text-white rounded-pill ps-4 pe-4" value="SEND"/>
						</form:form>
									<script type="text/javascript">
									let params = new URLSearchParams(location.search);
										document.querySelector("#message").value=params.get("message")
						...
						<div class="col-6 col-offset-2">
							...
							<div id="map" class="mb-2">
								...
								<iframe
									src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d62691.70156518758!2d106.76878855714699!3d10.87000071018454!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x317527587e9ad5bf%3A0xafa66f9c8be3c91!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVGjDtG5nIHRpbiDEkEhRRyBUUC5IQ00sIFNvbmcgSMOgbmgsIGtodSBwaOG7kSA2LCBMaW5oIFRydW5nLCBUaOG7pyDEkOG7qWMsIFRow6BuaCBwaOG7kSBI4buTIENow60gTWluaA!3m2!1d10.8699184!2d106.8038081!5e0!3m2!1svi!2s!4v1616317062630!5m2!1svi!2s"
