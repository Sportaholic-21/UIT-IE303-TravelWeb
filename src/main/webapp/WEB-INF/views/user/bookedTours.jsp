                      ...
                      <thead>
                        ...
                        <c:forEach var="tourNotStart" items="${tourNotStarts}">
                          <tr>
                            ...
                            <td>
                              <button data-type="delete" data-toggle="modal" data-target="#deleteModel" data-id="${tourNotStart.tourBookingID}" data-link="${pageContext.request.contextPath}/user/booked-tour/api/delete" type="button" rel="tooltip"
