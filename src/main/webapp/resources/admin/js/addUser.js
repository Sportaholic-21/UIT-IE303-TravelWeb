...
$(document).ready(function() {
  $("#pwdGen").on("click",genPass);
  $('#passField').passtrength({
    minChars: 4,
    passwordToggle: true,
    tooltip: true
  });
...
var pluginName = "passtrength",
      defaults = {
        ...
        eyeImg : '/UIT-IE303-TravelWeb/resources/admin/assets/img/eye.svg'
    };
