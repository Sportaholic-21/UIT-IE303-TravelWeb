...
update tour
set scheduleCoordinate = '103.988411, 22.475868, 103.75955690632118, 22.30774368781965, 107.04390713755039, 20.97287140293925, 105.8582641561314, 21.023756680309052'
where tourName = 'Ha Long Bay'

update tour
set scheduleCoordinate = '103.97441698499703, 22.480243438546413, 103.8416954576399, 22.3354309794022, 105.83593358637923, 21.02978888931015'
where tourName = 'Sapa City'

update tour
set scheduleCoordinate = '105.79476573596718, 21.217900852986123, 107.03917417656463, 20.97070535606187, 105.96875534255115, 20.250350021940722, 105.85644712087739, 21.022738704091708'
where tourName = 'Quang Ninh'

update tour
set scheduleCoordinate = '108.29938047795513, 15.880189129075003, 107.98866731247685, 15.99776606894012, 107.5790008768497, 16.472648521258417'
where tourName = 'Da Nang'

update tour
set scheduleCoordinate = '108.26091225391383, 10.98303340012986, 109.24168459774654, 12.216398237260345, 109.19608114312634, 12.26558728611357, 109.17966735770432, 12.2529775185103'
where tourName = 'Nha Trang'

update tour
set scheduleCoordinate = '140.33323664074456, 35.79081594383057, 139.0267361826666, 35.2512804336085, 138.72727753758744, 35.36135965085453, 139.62448597651024, 35.46486862155051'
where tourName = 'Tokyo'


update tour
set scheduleCoordinate = '140.36362951460225, 35.81653150221384, 135.52998061565725, 34.69169372774142, 138.72619862018786, 35.36656574740686, 139.77684730159925, 35.718240852556136'
where tourName = 'Osaka'

update tour
set scheduleCoordinate = '144.94630159384488, -37.828904150310606, 174.7344322566558, -36.860634769190284, -33.871597268314844, 151.2072227821072, 151.19713027081974, -33.85339447477942'
where tourID = 8 -- Auckland

update tour
set scheduleCoordinate = '2.345558897074439, 48.88685988203424, 2.296526415691078, 48.85673492009218, 6.105437196607668, 49.61124694117077, 8.681436604782052, 50.111405258077355'
where tourID = 12 -- Paris

update tour
set scheduleCoordinate = '-0.1250749976450482, 51.50266986068257, -0.14305028789655344, 51.50289821165239, -1.259707513674539, 51.7555972584516, -1.2675911726725428, 51.7580992172283, -1.8433622456862755, 51.83306422937963, 114.5470950119866, 4.621301456988099'
where tourID = 14 -- London

update tour
set scheduleCoordinate = '91.17937908719605, 29.7144072632149, 91.11910491084905, 29.655634034896515, 88.95644164697289, 29.342985425996453, 91.02363939506694, 29.6786169566231, 104.12566282887131, 30.71336991712082'
